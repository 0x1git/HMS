...
<head>    <meta charset="UTF-8">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">    <title>Golden Palace - Payment Management</title>
    <!-- boot -->
    ...
    <link rel="stylesheet" href="css/payment-table-fixes.css">
    <link rel="stylesheet" href="css/luxury-payment-table.css">
    <link rel="stylesheet" href="css/payment-table-enhancements.css">
    <link rel="stylesheet" href="css/payment-visual-enhancements.css">

</head>
<body>	<div class="searchsection">
        <input type="text" name="search_bar" id="search_bar" placeholder="search..." onkeyup="searchFun()">    </div>

    <div class="payment-table table-responsive-xl">
        <?php
...
<script src="javascript/payment-counter.js"></script>
<script src="javascript/payment-table-layout-fix.js"></script>
